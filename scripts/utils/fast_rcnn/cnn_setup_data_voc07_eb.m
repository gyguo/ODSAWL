function imdb = cnn_setup_data_voc07_eb(varargin)
%Setup PASCAL VOC 2007 data with precomputed EB proposals
%	@author: G.Y. Guo
...
if ~exist(opts.ebDir, 'dir')
  mkdir(opts.ebDir) ;
end

for i=1:numel(files)
  outPath = fullfile(opts.ebDir, files{i}) ;
