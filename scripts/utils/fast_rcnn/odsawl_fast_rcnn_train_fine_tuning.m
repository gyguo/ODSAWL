function [net, info] = odsawl_fast_rcnn_train_fine_tuning(gpus,...
    expPath,net,imdb,lrRatio,...
	varargin)
%train script for FastRcnn in ODSAW
%	@author: G.Y. Guo
opts.expDir = expPath;
...
opts.train.learningRate = 1e-3 / 64 * [ones(1,6) 0.1*ones(1,6)]*lrRatio;
opts.train.weightDecay = 0.0005 ;
opts.train.numEpochs = 12 ;
opts.train.derOutputs = {'losscls', 1, 'lossbbox', 1} ;
opts.train.plotStatistics = 0;
opts.lite = false  ;
